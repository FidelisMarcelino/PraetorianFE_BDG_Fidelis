...
export default function ProductList(){
    ...
    return(
        <div className="p-6">
            <p className="text-3xl font-bold text-center mb-6 mt-10">Marketplace CRUD</p>
            ...
            <div className="grid grid-cols-3 gap-6">
                {products.map(product => (
                    <div key={product.id} className="bg-blue-100 p-4 rounded">
                        ...
                        <button onClick={() => handleDelete(product.id)} className="bg-red-600 text-white px-4 py-1 rounded w-full mt-2">
                            Delete
                        </button>
                    </div>
                ))}
